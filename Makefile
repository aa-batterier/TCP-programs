all: tcp_send_message tcp_receive_and_send_message tcp_send_and_receive_message tcp_send_insta_message tcp_send_limited_repeated_messages tcp_send_unlimited_repeated_messages udp_receive_message udp_send_message udp_send_insta_message udp_send_limited_repeated_messages udp_send_unlimited_repeated_messages tcp_fork_proxy tcp_select_proxy
...
udp_send_limited_repeated_messages: udp_send_limited_repeated_messages.c
	gcc -Wall -g -o $@ udp_send_limited_repeated_messages.c

udp_send_unlimited_repeated_messages: udp_send_unlimited_repeated_messages.c
	gcc -Wall -g -o $@ udp_send_unlimited_repeated_messages.c

tcp_fork_proxy: tcp_fork_proxy.c
	gcc -Wall -g -o $@ tcp_fork_proxy.c

tcp_select_proxy: tcp_select_proxy.c
	gcc -Wall -g -o $@ tcp_select_proxy.c

clean:
	rm -rv tcp_send_message tcp_receive_and_send_message tcp_send_and_receive_message tcp_send_insta_message tcp_send_limited_repeated_messages tcp_send_unlimited_repeated_messages udp_receive_message udp_send_message udp_send_insta_message udp_send_limited_repeated_messages udp_send_unlimited_repeated_messages tcp_fork_proxy tcp_select_proxy
